    ...
    this.microformat.create = function(obj) {
        ...
        return {
            ...
            text : '<div id="' + htmlID + '" style="display: none">'
                ...
                +   '<p class="sherd-instructions">Create a selection by clicking Start Time and End Time buttons as the video plays or by manually typing in times in the associated edit boxes. Add title, tags and notes. Click Save when you are finished.</p>' 
                +      '<table width="100%" class="sherd-clipform-editing">'
                +       '<tr>'
                +         '<td>'
                ...
                +           '<input type="image" src="/site_media/img/selection_play.gif" value="play portion" id="btnPlayClip"/>'
                +         '</td>'
                +       '</tr>'
                +      '</table>'
                +'</div>'
